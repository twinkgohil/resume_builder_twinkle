...
const String COLLECTON_REF = "education";

class EducationDatabaseService {
  ...
  EducationDatabaseService() {
    _educationRef =
        _firestore.collection(COLLECTON_REF).withConverter<Education>(
  ...
  Stream<QuerySnapshot> getEducationData() {
    return _educationRef.snapshots();
  }

  void add(Education education) async {
    _educationRef.add(education);
  }

  void update(String educationId, Education education) {
